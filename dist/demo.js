	...
	var Demo0 = function (_Component) {
	    ...
	    function Demo0() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.start = function () {
	            _beeProgressBar2['default'].start();
	        }, _this.set = function () {
	            _beeProgressBar2['default'].set(0.4);
	        }, _this.inc = function () {
	            _beeProgressBar2['default'].inc();
	        }, _this.done = function () {
	...
	var Demo5 = function (_Component) {
	    ...
	    Demo5.prototype.render = function render() {
	        return _react2['default'].createElement(
	            'div',
	            { className: 'demo5' },
	            _react2['default'].createElement(_src2['default'], { size: 'sm', container: this, show: this.state.show }),
	            _react2['default'].createElement(_src2['default'], { container: this, show: this.state.show }),
	            _react2['default'].createElement(_src2['default'], { size: 'lg', container: this, show: this.state.show })
	        );
	    };
